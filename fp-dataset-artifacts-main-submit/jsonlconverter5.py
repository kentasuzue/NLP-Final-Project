...
with open('chaosNLI_v1.0\\chaosNLI_mnli_m.jsonl', 'r') as input_file:
    with open('chaosNLI_mnli_modified.jsonl', 'w') as output_file:
        for line in input_file:
            ...
            if entailment_count < 51 and neutral_count < 51 and contradiction_count < 51:
