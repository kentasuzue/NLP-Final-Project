...
with open('multinli_1.0\\multinli_1.0_dev_matched.jsonl', 'r') as input_file:
#with open('multinli_1.0\\multinli_1.0_train.jsonl', 'r') as input_file:
    with open('multinli_1.0_dev_matched_formatted.jsonl', 'w') as output_file:
    #with open('multinli_1.0_train_formatted.jsonl', 'w') as output_file:
