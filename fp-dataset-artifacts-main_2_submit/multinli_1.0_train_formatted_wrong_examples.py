...
with open("multinli_1.0_train_wrong_indices_set_1_and_2_and_3.txt", "r") as file:
    for line in file:
...
with open('multinli_1.0_train_formatted.jsonl', 'r') as input_file:
#with open('snli_1.0\\snli_1.0_train.jsonl', 'r') as input_file:
    with open('multinli_1.0_train_formatted_wrong_examples_.jsonl', 'w') as output_file:
